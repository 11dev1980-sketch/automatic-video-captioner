/**
 * Caption Editor Workspace UI Component
 * PURE UI COMPONENT - Contains only the UI elements for CaptionEditorWorkspace
 * Modify this file to change the visual appearance of the CaptionEditorWorkspace
 * 
...
const VideoPlayer = ({ videoUri, videoRef, onPlaybackStatusUpdate, style, onPlayPause, isPlaying }) => {
  ...
  return (
    <View style={style}>
      ...
      <video
        ...
        onLoadStart={() => {
          console.log('🎬 CaptionEditorWorkspaceUI: Video loading started');
        }}
        onLoadedData={(e) => {
          console.log('🎬 CaptionEditorWorkspaceUI: Video data loaded');
        ...
        onPlay={() => {
          console.log('🎬 CaptionEditorWorkspaceUI: Video playing');
          showControlsTemporarily();
          if (onPlaybackStatusUpdate) {
            onPlaybackStatusUpdate({
              isLoaded: true,
        ...
        onPause={() => {
          console.log('🎬 CaptionEditorWorkspaceUI: Video paused');
          showControlsTemporarily();
          if (onPlaybackStatusUpdate) {
            onPlaybackStatusUpdate({
              isLoaded: true,
        ...
        onError={(error) => {
          console.error('❌ CaptionEditorWorkspaceUI: Video error:', error);
        }}
      />
...
export function CaptionEditorWorkspaceUI({
    // Video state
    videoRef,
    videoUri,
    videoName,
